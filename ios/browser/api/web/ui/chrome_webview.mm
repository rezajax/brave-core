...
- (void)viewDidLoad {
  ...
  //[self loadURL:@"brave://version/?show-variations-cmd"];
  //[self loadURL:@"brave://version/?show-variations-cmd"];
  //[self loadURL:@"brave://adblock-internals"];
}
...
//  web::WebState::CreateParams webStateCreateParams(browser_state_);
//  std::unique_ptr<web::WebState> web_state_ =
...
//  static_cast<web::WebStateImpl*>(web_state_.get());
//  web::WebViewWebStateMap::FromBrowserState(
//      web_state_impl->GetBrowserState())
//      ->SetAssociatedWebViewForWebState(web_view_, web_state_impl);
//
//  if (web_view_) {
//    web_state_impl->RemoveAllWebFrames();
//    [web_view_ stopLoading];
//
//    config_provider.ResetWithWebViewConfiguration(web_view_.configuration);
//
//    web_state_impl->ClearWebUI();
//    web_state_impl->CreateWebUI(GURL("chrome://sync-internals"));
//
//    GURL url = net::GURLWithNSURL([NSURL
//    URLWithString:@"chrome://sync-internals"]);
//    web::NavigationManager::WebLoadParams params(url);
//    params.transition_type = ui::PAGE_TRANSITION_TYPED;
//    web_state_impl->GetNavigationManager()->LoadURLWithParams(params);
//
//    [web_view_ setWebState:web_state_.release()];
//    [web_view_ setWebStateObserver:web_state_observer_.release()];
//    [web_view_ setWebStateDelegate:web_state_delegate_.release()];
//  }
//}
