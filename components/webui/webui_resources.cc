...
GetWebUIResources() {
  static const base::NoDestructor<
      base::flat_map<std::string_view, std::vector<WebUISimpleItem>>>
      resources{{
#if !BUILDFLAG(IS_ANDROID) && !BUILDFLAG(IS_IOS)
          {"newtab",
...
GetWebUILocalizedStrings() {
  static const base::NoDestructor<base::flat_map<std::string_view, std::vector<WebUISimpleItem>>> localized_strings{{
      {"newtab",
       {
      ...
      {"adblock",
       {
           ...
           {"additionalFiltersWarning", IDS_ADBLOCK_ADDITIONAL_FILTERS_WARNING},
